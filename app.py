...
try:
    ...
    def get_realtime_data(tickers_list):
        ...
        # Download data for all tickers (2 Year History for EMA200)
        try:
    ...
    def color_diff_s1_logic(val):
        if isinstance(val, (int, float)):
            if val < 0: return 'color: #28a745; font-weight: bold;' # เขียวเข้ม
            elif 0 <= val <= 0.02: return 'color: #90EE90;' # เขียวอ่อน
            else: return 'color: #dc3545;' # แดง
        return ''
