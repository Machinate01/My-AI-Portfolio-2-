...
# --- 2. Initialize Session State (แก้ไขหุ้นตามข้อ 3) ---
...
try:
    ...
    # --- 8. UI Display (แก้ไขหัวข้อตามข้อ 1) ---
